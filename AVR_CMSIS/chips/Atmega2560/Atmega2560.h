...
typedef struct __attribute__((__packed__))
{
    ...
    /**
     * @brief Address 0xB1 (0xD1) - USART/MSPIM 2 Control and status register B
     * @note this register can either be USART or Master SPI (MSPI)!
     */
    union
    {
    ...
    /**
     * @brief Address 0xB2 (0xD2) - USART/MSPIM 2 Control and status register C
     *
     */
    union
    {
    ...
    /**
     * @brief Address 0xE6 (0x106) - Port K input pins
     *        Each bit in the register corresponds to a pin on Port D.
     *        Reading this register returns the current state of the pins.
     */
    union
    ...
    /**
     * @brief Address 0xE7 (0x107) - Port K data direction register
     *        Each bit in the register corresponds to a pin on Port A.
     *        Setting a bit to 1 configures the corresponding pin as an output,
     *        while setting it to 0 configures it as an input.
     *        Reading this register returns the current configuration of the pins.
    ...
    /**
     * @brief Address 0xE8 (0x108) - Port K output register
     *        Each bit in the register corresponds to a pin on Port K.
     *        Setting a bit to 1 sets the corresponding pin to high,
     *        while setting it to 0 sets it to low.
     *        Reading this register returns the current state of the pins.
     */
    ...
    /**
     * @brief Address 0xE9 (0x109) - Port L input pins
     *        Each bit in the register corresponds to a pin on Port D.
     *        Reading this register returns the current state of the pins.
     */
    union
    ...
    /**
     * @brief Address 0xEA (0x10A) - Port L data direction register
     *        Each bit in the register corresponds to a pin on Port A.
     *        Setting a bit to 1 configures the corresponding pin as an output,
     *        while setting it to 0 configures it as an input.
     *        Reading this register returns the current configuration of the pins.
    ...
    /**
     * @brief Address 0xEB (0x10B) - Port L output register
     *        Each bit in the register corresponds to a pin on Port K.
     *        Setting a bit to 1 sets the corresponding pin to high,
     *        while setting it to 0 sets it to low.
     *        Reading this register returns the current state of the pins.
